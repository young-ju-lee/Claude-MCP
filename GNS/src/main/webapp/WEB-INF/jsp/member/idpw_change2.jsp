...
<%@ include file="../common/taglib.jsp" %>
	...
	<!-- 2017.12.22  보안성검토 비번변경 및 다음에변경하기 페이지 추가 -->
	    ...
	    <div class="row">
	      <div class="col s12 offset-m3 m6">
	        <div class="page-title">
	          <div>
	            <h3>${user_id} 사용자의 비밀번호가 3개월 기간 만료 되었습니다.</br>
                                          비밀번호 변경 또는 다음에 변경하기 버튼을 눌러주세요            		
		  ...
		  <i class="material-icons kt-red-text">info_outline</i> 비밀번호는 영문자, 숫자, 특수문자 조합이면 8자 이상입니다.
	        ...
	        <a href="javascript:" onclick="javascript:return passPw();" class="btn btn-block kt-red">다음에 변경하기</a>
	      </div>
	    </div>
	  </div>
	</div>
...
function checkMsg(){
    ...
    //ID와 PW비교하여 ID에서 연속되는 문자 4개 있으면 리턴
     if(!validate_samepass2(document.UserForm.elements["new_pwd"].value)) {                    
        document.UserForm.new_pwd.focus();
        document.UserForm.new_pwd.select();
        return false;
    } 
