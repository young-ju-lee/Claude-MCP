...
var FCKeditor = function( instanceName, width, height, toolbarSet, value )
{
	...
	this.Value		= value			|| '' ;
	this.BasePath		= '/atmvit/atmvithome/manager/popup/FCKeditor/' ;
...
{
	var sFile = (/fcksource=true/i).test( window.top.location.search ) ? 'fckeditor.original.htm' : 'fckeditor.htm' ;
