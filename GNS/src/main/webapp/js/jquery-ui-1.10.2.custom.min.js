...
/* 웹접근성수정-1 start : prev, next 버튼에 포커스 주기 */this.clickbtn=null,/* 웹접근성수정-1 end */
...
/* 웹접근성수정-2 start : 초기값 수정 */
this.regional[""]={
	closeText:"달력 닫기",//수정
	prevText:"이전달",//수정
	nextText:"다음달",//수정
	currentText:"오늘",//수정
	monthNames:['1월','2월','3월','4월','5월','6월','7월','8월','9월','10월','11월','12월'],//수정
	monthNamesShort:['1월','2월','3월','4월','5월','6월','7월','8월','9월','10월','11월','12월'],//수정
	dayNames:['일요일', '월요일', '화요일', '수요일', '목요일', '금요일', '토요일'],//수정
	dayNamesShort:['일', '월', '화', '수', '목', '금', '토'],//수정
	dayNamesMin:['일', '월', '화', '수', '목', '금', '토'],//수정
	weekHeader:"Wk",
	dateFormat:"yy-mm-dd",//수정
	firstDay:0,
	isRTL:!1,
	showMonthAfterYear:1,//수정
	yearSuffix:"년"//수정
},
this._defaults={
	showOn:"focus",
...
_adjustDate:function(e,i,s){
	...
	/* 웹접근성수정-3 start : prev, next 버튼에 포커스 주기 */if(this.clickbtn != null){a.dpDiv.find(".ui-datepicker-"+this.clickbtn).focus();}/* 웹접근성수정-3 end */
},
...
_attachHandlers:function(e){
	...
	e.dpDiv.find("[data-handler]").map(function(){var e={
		prev:function(){
			/* 웹접근성수정-4 start : prev, next 버튼에 포커스 주기 */window["DP_jQuery_"+o].datepicker.clickbtn="prev";/* 웹접근성수정-4 end */
			window["DP_jQuery_"+o].datepicker._adjustDate(s,-i,"M")
		},
		next:function(){
			/* 웹접근성수정-4 start : prev, next 버튼에 포커스 주기 */window["DP_jQuery_"+o].datepicker.clickbtn="next";/* 웹접근성수정-4 end */
			window["DP_jQuery_"+o].datepicker._adjustDate(s,+i,"M")
		},
		hide:function(){
			/* 웹접근성수정-4 start : prev, next 버튼에 포커스 주기 */window["DP_jQuery_"+o].datepicker.clickbtn=null;/* 웹접근성수정-4 end */
			/* 웹접근성수정-5 start : 숨길때 달력버튼에 포커스 주기 */
				//기본코드
				//window["DP_jQuery_"+o].datepicker._hideDatepicker();

				//수정코드
				$(this).closest('.calendar').hide();
				$('.btnCalendar[href="#'+$(this).closest('.calendar').attr('id')+'"]').focus();
			/* 웹접근성수정-5 end */
		},
		today:function(){
			/* 웹접근성수정-4 start : prev, next 버튼에 포커스 주기 */window["DP_jQuery_"+o].datepicker.clickbtn=null;/* 웹접근성수정-4 end */
...
_generateHTML:function(t){var e,i,s,n,a,r,o,h,l,c,u,d,p,f,m,g,v,_,b,y,w,k,x,D,T,C,S,M,N,I,P,A,z,H,E,F,O,W,j,R=new Date,L=this._daylightSavingAdjust(new Date(R.getFullYear(),R.getMonth(),R.getDate())),Y=this._get(t,"isRTL"),B=this._get(t,"showButtonPanel"),J=this._get(t,"hideIfNoPrevNext"),Q=this._get(t,"navigationAsDateFormat"),K=this._getNumberOfMonths(t),V=this._get(t,"showCurrentAtPos"),U=this._get(t,"stepMonths"),q=1!==K[0]||1!==K[1],X=this._daylightSavingAdjust(t.currentDay?new Date(t.currentYear,t.currentMonth,t.currentDay):new Date(9999,9,9)),G=this._getMinMaxDate(t,"min"),$=this._getMinMaxDate(t,"max"),Z=t.drawMonth-V,te=t.drawYear;if(0>Z&&(Z+=12,te--),$)for(e=this._daylightSavingAdjust(new Date($.getFullYear(),$.getMonth()-K[0]*K[1]+1,$.getDate())),e=G&&G>e?G:e;this._daylightSavingAdjust(new Date(te,Z,1))>e;)Z--,0>Z&&(Z=11,te--);for(t.drawMonth=Z,t.drawYear=te,i=this._get(t,"prevText"),i=Q?this.formatDate(i,this._daylightSavingAdjust(new Date(te,Z-U,1)),this._getFormatConfig(t)):i,

		/* 웹접근성수정-6 start : prev a 태그에 href='#none' 추가 */
		s=this._canAdjustMonth(t,-1,te,Z)?"<a href='#none' class='ui-datepicker-prev ui-corner-all' data-handler='prev' data-event='click' title='"+i+"'><span class='ui-icon ui-icon-circle-triangle-"+(Y?"e":"w")+"'>"+i+"</span></a>":J?"":"<a href='#none' class='ui-datepicker-prev ui-corner-all ui-state-disabled' title='"+i+"'><span class='ui-icon ui-icon-circle-triangle-"+(Y?"e":"w")+"'>"+i+"</span></a>",
		/* 웹접근성수정-6 end */

		n=this._get(t,"nextText"),
		n=Q?this.formatDate(n,this._daylightSavingAdjust(new Date(te,Z+U,1)),this._getFormatConfig(t)):n,

		/* 웹접근성수정-7 start : next a 태그에 href='#none' 추가 */
		a=this._canAdjustMonth(t,1,te,Z)?"<a href='#none' class='ui-datepicker-next ui-corner-all' data-handler='next' data-event='click' title='"+n+"'><span class='ui-icon ui-icon-circle-triangle-"+(Y?"w":"e")+"'>"+n+"</span></a>":J?"":"<a href='#none' class='ui-datepicker-next ui-corner-all ui-state-disabled' title='"+n+"'><span class='ui-icon ui-icon-circle-triangle-"+(Y?"w":"e")+"'>"+n+"</span></a>",
		/* 웹접근성수정-7 end */

		r=this._get(t,"currentText"),
		o=this._get(t,"gotoCurrent")&&t.currentDay?X:L,r=Q?this.formatDate(r,o,this._getFormatConfig(t)):r,

		/* 웹접근성수정-8 start : 닫기 버튼 수정 */
		//기본코드
		...
		//수정코드
		h='<a href="#none" class="ui-datepicker-close" data-handler="hide" data-event="click"><span>'+this._get(t,'closeText')+'</span></a>',
		l=B?'<div class="ui-datepicker-buttonpane ui-widget-content">'+h+'</div>':'',
		/* 웹접근성수정-8 end */

		c=parseInt(this._get(t,"firstDay"),10),c=isNaN(c)?0:c,u=this._get(t,"showWeek"),d=this._get(t,"dayNames"),p=this._get(t,"dayNamesMin"),f=this._get(t,"monthNames"),m=this._get(t,"monthNamesShort"),g=this._get(t,"beforeShowDay"),v=this._get(t,"showOtherMonths"),_=this._get(t,"selectOtherMonths"),b=this._getDefaultDate(t),y="",k=0;K[0]>k;k++){for(x="",this.maxRows=4,D=0;K[1]>D;D++){if(T=this._daylightSavingAdjust(new Date(te,Z,t.selectedDay)),C=" ui-corner-all",S="",q){if(S+="<div class='ui-datepicker-group",K[1]>1)switch(D){case 0:S+=" ui-datepicker-group-first",C=" ui-corner-"+(Y?"right":"left");break;case K[1]-1:S+=" ui-datepicker-group-last",C=" ui-corner-"+(Y?"left":"right");break;default:S+=" ui-datepicker-group-middle",C=""}S+="'>"}

		/* 웹접근성수정-9 start : table summary, caption, scope 수정 및 추가 */
		for(S+="<div class='ui-datepicker-header ui-widget-header ui-helper-clearfix"+C+"'>"+(/all|left/.test(C)&&0===k?Y?a:s:"")+(/all|right/.test(C)&&0===k?Y?s:a:"")+this._generateMonthYearHeader(t,Z,te,G,$,k>0||D>0,f,m)+"</div><table class='ui-datepicker-calendar' summary='날짜 선택을 위한 달력을 일,월,화,수,목,금,토 요일 순으로 나타낸 표'><caption>날짜 선택용 달력</caption><thead>"+"<tr>",M=u?"<th scope='col' class='ui-datepicker-week-col'>"+this._get(t,"weekHeader")+"</th>":"",w=0;7>w;w++)N=(w+c)%7,M+="<th scope='col'"+((w+c+6)%7>=5?" class='ui-datepicker-week-end'":"")+">"+"<span title='"+d[N]+"'>"+p[N]+"</span></th>";for(S+=M+"</tr></thead><tbody>",I=this._getDaysInMonth(te,Z),te===t.selectedYear&&Z===t.selectedMonth&&(t.selectedDay=Math.min(t.selectedDay,I)),P=(this._getFirstDayOfMonth(te,Z)-c+7)%7,A=Math.ceil((P+I)/7),z=q?this.maxRows>A?this.maxRows:A:A,this.maxRows=z,H=this._daylightSavingAdjust(new Date(te,Z,1-P)),E=0;z>E;E++){for(S+="<tr>",F=u?"<td class='ui-datepicker-week-col'>"+this._get(t,"calculateWeek")(H)+"</td>":"",w=0;7>w;w++)O=g?g.apply(t.input?t.input[0]:null,[H]):[!0,""],W=H.getMonth()!==Z,j=W&&!_||!O[0]||G&&G>H||$&&H>$,F+="<td class='"+((w+c+6)%7>=5?" ui-datepicker-week-end":"")+(W?" ui-datepicker-other-month":"")+(H.getTime()===T.getTime()&&Z===t.selectedMonth&&t._keyEvent||b.getTime()===H.getTime()&&b.getTime()===T.getTime()?" "+this._dayOverClass:"")+(j?" "+this._unselectableClass+" ui-state-disabled":"")+(W&&!v?"":" "+O[1]+(H.getTime()===X.getTime()?" "+this._currentClass:"")+(H.getTime()===L.getTime()?" ui-datepicker-today":""))+"'"+(W&&!v||!O[2]?"":" title='"+O[2].replace(/'/g,"&#39;")+"'")+(j?"":" data-handler='selectDay' data-event='click' data-month='"+H.getMonth()+"' data-year='"+H.getFullYear()+"'")+">"+(W&&!v?"&#xa0;":j?"<span class='ui-state-default'>"+H.getDate()+"</span>":"<a class='ui-state-default"+(H.getTime()===L.getTime()?" ui-state-highlight":"")+(H.getTime()===X.getTime()?" ui-state-active":"")+(W?" ui-priority-secondary":"")+"' href='#'>"+H.getDate()+"</a>")+"</td>",H.setDate(H.getDate()+1),H=this._daylightSavingAdjust(H);S+=F+"</tr>"}Z++,Z>11&&(Z=0,te++),S+="</tbody></table>"+(q?"</div>"+(K[0]>0&&D===K[1]-1?"<div class='ui-datepicker-row-break'></div>":""):""),x+=S}y+=x}return y+=l,t._keyEvent=!1,y},_generateMonthYearHeader:function(t,e,i,s,n,a,r,o){var h,l,c,u,d,p,f,m,g=this._get(t,"changeMonth"),v=this._get(t,"changeYear"),_=this._get(t,"showMonthAfterYear"),b="<div class='ui-datepicker-title'>",y="";if(a||!g)y+="<span class='ui-datepicker-month'>"+r[e]+"</span>";else{for(h=s&&s.getFullYear()===i,l=n&&n.getFullYear()===i,y+="<select class='ui-datepicker-month' data-handler='selectMonth' data-event='change'>",c=0;12>c;c++)(!h||c>=s.getMonth())&&(!l||n.getMonth()>=c)&&(y+="<option value='"+c+"'"+(c===e?" selected='selected'":"")+">"+o[c]+"</option>");
		/* 웹접근성수정-9 end */
